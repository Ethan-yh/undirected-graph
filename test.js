...
function initDatas() {
    ...
    // text.setStyle(Q.Styles.LABEL_BACKGROUND_COLOR, Colors.blue);
    // text.setStyle(Q.Styles.LABEL_COLOR, "#FFF");
    // text.setStyle(Q.Styles.LABEL_PADDING, new Q.Insets(3, 5));
    ...
    // graph.removeElement(text)

}

graph.setInteractionMode(Q.Consts.INTERACTION_MODE_CREATE_SIMPLE_EDGE);

var toolbar = Q.createToolbar(window.graph, document.getElementById("toolbar"));